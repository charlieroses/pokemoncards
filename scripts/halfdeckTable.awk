BEGIN {
	...
	print "<table>"
	print "<tr><th>Deck</th><th>Set Number</th><th>Dex</th><th>Pokemon</th><th>Type</th><th>Holo</th><th>Other</th><th>Artist</th></tr>"
}

NR > 1{
	deck_td = "<td class=\"deck\"><img src=\"./images/halfdecks/" $8 "halfdeck.png\" alt=\"" $8 "\"></td>"
	...
	print "<tr>" deck_td num_td dex_td pkmn_td type_td holo_td info_td art_td "</tr>"
}
