BEGIN {
	...
	print "<table>"
	print "<tr><th>Series</th><th>Set Number</th><th>Dex</th><th>Pokemon</th><th>Type</th><th>Holo</th><th>Other</th><th>Artist</th></tr>"
}

NR > 1{
	pop_td  = "<td class=\"pops\"><img src=\"images/popseries/" $8 ".png\"></td>"
	...
	print "<tr>" pop_td num_td dex_td pkmn_td type_td holo_td info_td art_td "</tr>"
}
